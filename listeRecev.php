...
<body>
    ...
    <!--navbar-->    <!--SE CONNECTER-->
    <h1 style="position: absolute;text-align: center;top: 270px;left:30%;color:gold;">LA LISTE DES RECEVEUR EST</h1>
            ...
            <tbody id="tbody">
                ...
                ?>
                    <tr style="background:white;color:black;">
                        <th><?= $tab['id_receveur'] ?></th>
                        <th><?= $tab['nom_receveur'] ?></th>
                        <th><?= $tab['prenom_receveur'] ?></th>
                        <th><?= $tab['telephone_receveur'] ?></th>
                        <th><?= $tab['age_receveur'] ?></th>
                        <th>
                            <button class="btn btn-sm" style="background-color: blue;color:white;" onclick="Modifier(<?= $i ?>)" name="modifier<?= $i ?>" value="<?= $i ?>" formaction="page10.php" >Modifier</button>
                            <button class="btn btn-danger btn-sm" onclick="Supprimer(<?= $i ?>)" name="delete<?= $i ?>" value="<?= $i ?>"formaction="page12.php">Supprimer</button>
                        </th>
                    </tr>
                    <?php } ?>
                </tbody>
