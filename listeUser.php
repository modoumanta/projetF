...
<body>
    ...
    <!--navbar-->
    <!--SE CONNECTER-->
    <h1 style="position: absolute;text-align: center;top: 270px;left:30%;color:gold;">LA LISTE DES UTILISATEURS EST</h1>
            ...
            <tbody id="tbody">
                ...
                ?>
                    <tr style="background:white;color:black;">
                        <th><?= $tab['id_utilisateur'] ?></th>
                        <th><?= $tab['nom_utilisateur'] ?></th>
                        <th><?= $tab['prenom_utilisateur'] ?></th>
                        <th><?= $tab['telephone_utilisateur'] ?></th>
                        <th><?= $tab['mail_utilisateur'] ?></th>
                        <th><?= $tab['login_utilisateur'] ?></th>
                        <th>
                            <button class="btn btn-sm" style="background-color: blue;color:white;" onclick="Modifier(<?= $i ?>)" name="modifier<?= $i ?>" value="<?= $i ?>" formaction="page5.php" >Modifier</button>
                            <button class="btn btn-danger btn-sm" onclick="Supprimer(<?= $i ?>)" name="delete<?= $i ?>" value="<?= $i ?>"formaction="page7.php">Supprimer</button>
                        </th>
                    </tr>
                    <?php } ?>
                </tbody>
