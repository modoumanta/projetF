...
<body>
    ...
    <!--navbar-->    <!--SE CONNECTER-->
    <h1 style="position: absolute;text-align: center;top: 270px;left:30%;color:gold;">LA LISTE DES CHAUFFEURS EST</h1>
            ...
            <tbody id="tbody">
                ...
                ?>
                    <tr style="background:white;color:black;">
                        <th><?= $tab['id_chauffeur'] ?></th>
                        <th><?= $tab['nom_chauffeur'] ?></th>
                        <th><?= $tab['prenom_chauffeur'] ?></th>
                        <th><?= $tab['telephone_chauffeur'] ?></th>
                        <th><?= $tab['age'] ?></th>
                        <th><?= $tab['permis_chauffeur'] ?></th>
                        <th>
                            <button class="btn btn-sm" style="background-color: blue;color:white;" onclick="Modifier(<?= $i ?>)" name="modifier<?= $i ?>" value="<?= $i ?>" formaction="pageC3.php" >Modifier</button>
                            <button class="btn btn-danger btn-sm" onclick="Supprimer(<?= $i ?>)" name="delete<?= $i ?>" value="<?= $i ?>"formaction="pageC5.php">Supprimer</button>
                        </th>
                    </tr>
                    <?php } ?>
                </tbody>
